<body>
    ...
    <div class="row m-0 p-5">
        ...
        <div class="text-center py-3">
            <a class="btn btn-primary" href="index.php?ctl=Organisateur&action=AjouterStade">Ajouter un stade</a>
        </div>
        ...
        <?php for ($i=0; $i < count($result); $i++) { 
            ...
            <div class="row border">
                ...
                <div class="col-4 text-center py-1">
                    <a class="btn btn-info" href="index.php?ctl=Organisateur&action=EditerStade&id_stade='.$result[$i]['id_stade'].'">Modifier</a>

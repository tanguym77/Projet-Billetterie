...
<footer class="text-center pt-5">
  ...
  <div class="row m-0 justify-content-between py-3">
    ...
    <div class="col-md-4 py-3 justify-content-end text-center">
      <a class="text-body-secondary px-2" href="https://twitter.com/fortnitegame/" target="_blank"><i class="bi bi-twitter-x fs-3"></i></a>
      <a class="text-body-secondary px-2" href="https://www.instagram.com/OGTrumpQueen/" target="_blank"><i class="bi bi-instagram fs-3"></i></a>
      <a class="text-body-secondary px-2" href="https://fr-fr.facebook.com/Otterlifes/" target="_blank"><i class="bi bi-facebook fs-3"></i></a>
  </div>
  </div>
</footer>
